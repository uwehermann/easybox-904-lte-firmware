...
#endif
#ifdef IFX_CFG_FLASH_LTE_FW_BLOCK_NAME
  "f_ltefw_addr=" MK_STR(IFX_CFG_FLASH_LTE_FW_START_ADDR) "\0"
  "f_ltefw_size=" MK_STR(IFX_CFG_FLASH_LTE_FW_SIZE) "\0"
  "f_ltefw_end="  MK_STR(IFX_CFG_FLASH_LTE_FW_END_ADDR) "\0"
#endif
#ifndef CONFIG_FIRMWARE_IN_ROOTFS

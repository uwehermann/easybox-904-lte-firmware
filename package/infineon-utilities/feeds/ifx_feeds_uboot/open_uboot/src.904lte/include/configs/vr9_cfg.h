...
//4MB flash partition
  ...
  #define IFX_CFG_FLASH_PARTITIONS_INFO							\
        ...
        "part12_begin=0x08C00000\0" /* misc, 339M*/				\
        "part13_begin=0x1DF00000\0" /* ltefw, 32M*/				\
        "part14_begin=0x1FF00000\0" /* BBT, 1M*/				\
        "total_part=15\0"
  ...
  #define IFX_CFG_FLASH_DATA_BLOCKS_INFO							\
        ...
        "data_block13=" IFX_CFG_FLASH_LTE_FW_BLOCK_NAME "\0"		\
        "total_db=14\0"
  ...
  #define IFX_CFG_FLASH_MISC_SIZE						0x15300000
  #define IFX_CFG_FLASH_MISC_END_ADDR					0x1DEFFFFF
  #define IFX_CFG_FLASH_MISC_MTDBLOCK_NAME				"/dev/mtdblock12"

  #define IFX_CFG_FLASH_LTE_FW_BLOCK_NAME				"ltefw"
  #define IFX_CFG_FLASH_LTE_FW_START_ADDR				0x1DF00000
  #define IFX_CFG_FLASH_LTE_FW_SIZE 					0x02000000
  #define IFX_CFG_FLASH_LTE_FW_END_ADDR					0x1FEFFFFF
  #define IFX_CFG_FLASH_LTE_FW_MTDBLOCK_NAME			"/dev/mtdblock13"

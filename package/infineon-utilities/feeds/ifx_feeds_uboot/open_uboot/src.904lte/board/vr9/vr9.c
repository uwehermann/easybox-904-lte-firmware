...
int checkboard (void)
{
	...
	*(EBU_CON_0+2)        = 0x0001d7ff; /* EBU_CON_2 */
	...
	/* ctc, reset GPHY */
	*BSP_GPIO_P1_ALTSEL0 = *BSP_GPIO_P1_ALTSEL0 & ~(0x2000);
	*BSP_GPIO_P1_ALTSEL1 = *BSP_GPIO_P1_ALTSEL1 & ~(0x2000);
	*BSP_GPIO_P1_DIR     = *BSP_GPIO_P1_DIR | 0x2000;
	*BSP_GPIO_P1_OD      = *BSP_GPIO_P1_OD | 0x2000;
	*BSP_GPIO_P1_OUT     = *BSP_GPIO_P1_OUT | 0x2000;
	*BSP_GPIO_P1_OUT     = *BSP_GPIO_P1_OUT & ~(0x2000);
	asm( "sync" );
	msleep( 10 );
	*BSP_GPIO_P1_OUT     = *BSP_GPIO_P1_OUT | 0x2000;
